...
import 'package:smarttailor/models/Order_Model.dart';
...
class _OrdersListState extends State<OrdersList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _ordersProvider.getMyOrdersList.isEmpty? Center(
        child: Column(
                                 ...
                                 children: [
                                   Card(
                                     child:Column(
                                       children: [
                                         ExpansionTile(
                                           title: Text('Ordered Items ${order.itemList.length}'),
                                           children: [
                                             ListView.builder(
                                               physics: ClampingScrollPhysics(),
                                               ...
                                               itemBuilder: (context,index){
                                                 ...
                                                 return ListTile(
                                                   leading: Image.network(
                                                     order.itemList[index]["cartImage"],
                                                     width: 60.0,
                                                   ),
                                                   title: Row(
                                                     ...
                                                     children: [
                                                       Text(
                                                         order.itemList[index]["cartName"],
                                                         style: TextStyle(
                                                             color: Colors.grey[600],
                                                             fontWeight: FontWeight.bold),
                                                       ),
                                                       Text('\Rs'+order.itemList[index]["cartPrice"].toString()),
                                                     ],
                                                   ),
                                                   subtitle: Text(""),
                                                 );
                                    ...
                                    Divider(),
                                   ListTile(
                                     leading: Text("Shipping Charges",style: TextStyle(color: Colors.black,fontSize: 14.0),),
                                     trailing: Text("200"),
                                   ),
                                   ListTile(
                                     leading: Text("Sub Total",style: TextStyle(color: Colors.black,fontSize: 14.0,fontWeight: FontWeight.bold),),
