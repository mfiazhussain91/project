...
class CheckoutProvider with ChangeNotifier {
  ...
  late DeliveryAddressMode deliveryAddressList;
  void getDeliveryAddressData() async {
    // DeliveryAddressMode _newList;
    DeliveryAddressMode _deliveryAddressModel;
    DocumentSnapshot _db = await FirebaseFirestore.instance
        .collection("AddDeliverAddress")
        .doc(FirebaseAuth.instance.currentUser!.uid)
        .get();
    if (_db.exists) {
      _deliveryAddressModel = DeliveryAddressMode(
      ...
      deliveryAddressList = _deliveryAddressModel;
      notifyListeners();
    }
  }

  DeliveryAddressMode get getDeliveryAddressList {
