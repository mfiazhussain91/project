...
import 'package:smarttailor/productsdescription/pantsdescription.dart';
...
class _BabiesCollectionState extends State<BabiesCollection> {
  ...
  getShirts() {
    ...
    productProvider.getMyProductsList.where((element) {
      return element.productCategory.toLowerCase().contains("other") && element.genderCategory==1;
    }).toList();
    return products;
  }
  @override
