...
import 'package:smarttailor/tailorscreens/customer_order_details.dart';
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                    ...
                                    itemBuilder: (context,index){
                                      ...
                                      return order.ItemsList[index]["tailorId"]==FirebaseAuth.instance.currentUser!.uid ?
                                      Row(
                                        children: [
                                          Container(
                                        ...
                                        child: MaterialButton(
                                          onPressed: () {
                                             Navigator.of(context).push(MaterialPageRoute(builder: (context)=>DetailPageofCustomerOrder(
                                               ...
                                               customerImage:  order.ItemsList[0]["customerImage"],
                                               area: order.area,
                                               city: order.city,
