...
class BurewalaPainterShopDetail extends StatefulWidget {
  const BurewalaPainterShopDetail({Key? key}) : super(key: key);

  @override
  _BurewalaPainterShopDetailState createState() => _BurewalaPainterShopDetailState();
}

class _BurewalaPainterShopDetailState extends State<BurewalaPainterShopDetail> {
