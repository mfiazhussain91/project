...
class BurewalaElectricShopDetail extends StatefulWidget {
  const BurewalaElectricShopDetail({Key? key}) : super(key: key);

  @override
  _BurewalaElectricShopDetailState createState() => _BurewalaElectricShopDetailState();
}

class _BurewalaElectricShopDetailState extends State<BurewalaElectricShopDetail> {
