...
class BurewalaElectricShop extends StatefulWidget {
  const BurewalaElectricShop({Key? key}) : super(key: key);

  @override
  _BurewalaElectricShopState createState() => _BurewalaElectricShopState();
}

class _BurewalaElectricShopState extends State<BurewalaElectricShop> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => BurewalaElectricShopDetail()));
