...
class VehariElectShopDetail extends StatefulWidget {
  const VehariElectShopDetail({Key? key}) : super(key: key);

  @override
  _VehariElectShopDetailState createState() => _VehariElectShopDetailState();
}

class _VehariElectShopDetailState extends State<VehariElectShopDetail> {
      ...
      body: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              Padding(
                  padding: EdgeInsets.symmetric(horizontal: 20),
                  child: Text("mfiazhissain91@gmail.com",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 16,
                      // fontWeight: FontWeight.bold
              ...
              Padding(
                  padding: EdgeInsets.symmetric(horizontal: 20),
                  child: Text("Club Raod,Vehari,Punjab,Pakistan ",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 16,
                      // fontWeight: FontWeight.bold
