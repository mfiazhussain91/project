...
class BurewalaMasonShopDetail extends StatefulWidget {
  const BurewalaMasonShopDetail({Key? key}) : super(key: key);

  @override
  _BurewalaMasonShopDetailState createState() => _BurewalaMasonShopDetailState();
}

class _BurewalaMasonShopDetailState extends State<BurewalaMasonShopDetail> {
      ...
      body: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              Padding(
                  padding: EdgeInsets.symmetric(horizontal: 20),
                  child: Text("Burewala Construction",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 16,
                      // fontWeight: FontWeight.bold
