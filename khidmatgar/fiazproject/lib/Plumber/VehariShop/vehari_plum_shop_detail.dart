...
class VehariPlumShopDetail extends StatefulWidget {
  const VehariPlumShopDetail({Key? key}) : super(key: key);

  @override
  _VehariPlumShopDetailState createState() => _VehariPlumShopDetailState();
}

class _VehariPlumShopDetailState extends State<VehariPlumShopDetail> {
